...
fun <K, V> referenceHashMapOf(vararg pairs: Pair<K, V>): ReferenceHashMap<K, V> {
...
fun <K, V> referenceMapOf(vararg pairs: Pair<K, V>): ReferenceMap<K, V> = referenceHashMapOf(*pairs)
