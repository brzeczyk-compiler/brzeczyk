...
class FunctionDependenciesAnalyzerTest {
    ...
    @Test fun `test operators`() {
        ...
        */
        ...
        val testFunction = Function("test", listOf(), Type.Unit, listOf(
    ...
    @Test fun `test control flow`() {
        ...
        */
        ...
        val testFunction = Function("test", listOf(), Type.Number, listOf(
    ...
    @Test fun `test arguments`() {
        ...
        */
        ...
        val fFunction = Function("f", listOf(
        ...
        val gFunction = Function("g", listOf(
